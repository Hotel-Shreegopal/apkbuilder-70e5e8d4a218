            ...
            GridView.count(
              ...
              children: [
                _QuickActionCard(
                  icon: Icons.list_alt,
                  label: 'Notes',
                  onTap: () => Navigator.pushNamed(context, '/note_list_screen'),
                ),
                _QuickActionCard(
                  icon: Icons.dashboard,
                  label: 'Note Detail',
                  onTap: () => Navigator.pushNamed(context, '/note_detail_screen'),
                ),
                _QuickActionCard(
                  icon: Icons.edit_note,
                  label: 'Add Note',
                  onTap: () => Navigator.pushNamed(context, '/note_form_screen'),
                ),
                _QuickActionCard(
                  icon: Icons.settings,
                  label: 'Settings',
